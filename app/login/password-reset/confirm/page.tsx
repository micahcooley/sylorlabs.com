    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-black/40 backdrop-blur-xl border border-red-500/30 rounded-2xl p-8 max-w-md w-full"
        >
          <div className="text-center">
            ...
            <div className="space-y-3">
              <Link href="/login/password-reset" className="block w-full bg-gradient-to-r from-primary to-secondary text-white py-3 rounded-lg font-semibold text-center hover:shadow-neon-magenta transition-all duration-300">
                Request New Reset Link
              </Link>
              <Link href="/login" className="block text-center text-gray-400 hover:text-primary transition-colors duration-200">
                Back to Login
              </Link>
            </div>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-black/40 backdrop-blur-xl border border-green-500/30 rounded-2xl p-8 max-w-md w-full"
        >
          <div className="text-center">
            ...
            <Link href="/login" className="block w-full bg-gradient-to-r from-primary to-secondary text-white py-3 rounded-lg font-semibold text-center hover:shadow-neon-magenta transition-all duration-300">
              Go to Login
            </Link>
          </div>
        </motion.div>
      ...
      >
        ...
        <div className="bg-black/40 backdrop-blur-xl border border-neon-magenta/30 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <Link href="/login" className="text-gray-400 hover:text-primary transition-colors duration-200 text-sm">
              ← Back to Login
            </Link>
          </div>
        </div>
